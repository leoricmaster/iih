...
一句话：**媒介是"在哪儿拿到的"，载体是"什么形态"，信源是"谁说的"，途径是"从哪个出口说的"（decision-17），情报是"说了什么"，研究课题是"想知道什么"，命题是"信什么、求证什么"，实体是"说的是谁"（知识底座）。**
...
erDiagram
    ...
    情报需求 }o--o{ 情报条目 : "命中"
    媒介 ||--o{ 途径 : "发布场景（decision-17）"
    媒介 ||--o{ 情报条目 : "获取场景"
    载体 ||--o{ 情报条目 : "素材形态"
    信源 ||--o{ 途径 : "发布（decision-17）"
    途径 ||--o{ 情报条目 : "采集（经转引链）"
    信源 ||--o{ 情报条目 : "产出（经转引链，出处信源与信用归因对象）"
    信源 ||--o{ 信源 : "转引 / 独立性关联"
    信源 }o--o| 实体 : "挂实体（decision-17）"
